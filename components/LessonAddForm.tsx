...
export const LessonAddForm = ({addLesson, showForm, hideForm} : {showForm: boolean,hideForm: Function,addLesson: Function}) => {
  ...
  return (
        ...
        >
          <View style={{height:430,padding:10,borderTopRightRadius:20,borderTopLeftRadius:20,backgroundColor:'#252525',width:"100%"}}>
            <Text style={{textAlign:'center',marginBottom:8 ,fontSize:25,fontWeight:'900', color:'white'}}>Add Lesson</Text>
            {
              pickerFor &&
             <DateTimePicker
            ...
            <Pressable onPress={createLesson} style={{backgroundColor:'white', padding:10,margin:3,alignItems:'center',borderRadius:10}}>
